...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.recycler_view_main),
                        childAtPosition(
                                withId(R.id.phone_main_linear_layout),
                                0)));
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tv_shortDescription), withText("Starting prep"),
                        childAtPosition(
                                allOf(withId(R.id.list_item_baking_steps),
                                        childAtPosition(
                                                withId(R.id.recycler_view_steps),
                                                1)),
                                0),
                        isDisplayed()));
